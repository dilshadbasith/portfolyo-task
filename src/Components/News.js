					...
					<ul>
						<li class="wow fadeInUp" data-wow-duration="1.5s">
							<div class="list_inner">
								<div class="image">
									<img src={thumbs4} alt="" />
									<div class="main" style={{ backgroundImage: `url(${news1})` }}></div>
						...
						<li class="wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
							<div class="list_inner">
								<div class="image">
									<img src={thumbs4} alt="" />
									<div class="main" style={{ backgroundImage: `url(${news2})` }}></div>
									<a class="ryker_tm_full_link" href="#"></a>
								</div>
								<div class="details">
						...
						<li class="wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
							<div class="list_inner">
								<div class="image">
									<img src={thumbs4} alt="" />
									<div class="main" style={{ backgroundImage: `url(${news3})` }}></div>
									<a class="ryker_tm_full_link" href="#"></a>
								</div>
								<div class="details">
